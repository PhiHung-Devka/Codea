        ...
        <div className="container">
            <Typography>
                ...
                <Paragraph style={{ fontSize: 16 }}>
                    Chúng tôi luôn nỗ lực để mang lại trải nghiệm mua sắm tốt nhất cho khách hàng. Trong trường hợp sản phẩm không như mong đợi, Codea hỗ trợ đổi/trả theo chính sách dưới đây:
                </Paragraph>
                ...
                <Paragraph style={{ fontSize: 16 }}>
                    <Text strong>Sản phẩm sẽ được chấp nhận đổi/trả nếu:</Text>
                    <ul>
                    ...
                    <Text strong>Không áp dụng đổi trả đối với:</Text>
                    <ul>
